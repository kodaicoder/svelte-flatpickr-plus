---
title: Advance usage of Multiple date picker
---
...
<script>
	...
	const options = {
		...
		defaultDate: [
			...
			new Date().setDate(new Date().getDate() + 4) /**Set default date date to next 4 date*/ // [svp! ++]
		]
	};
</script>
...
// [svp! ++]	<section>
// [svp! ++]		<label for="datePicker_1">Multiple date picker:
// [svp! ++]		<br />
// [svp! ++]		<input name="datePicker_1" use:svlatepickr={altInputOptions}>
// [svp! ++]	</section>
// [svp! ++]	<br />
// [svp! ++]	<section>
// [svp! ++]		<label for="datePicker_2">Multiple date picker with initial date: </label>
// [svp! ++]		<br />
// [svp! ++]		<input id="datePicker_2" name="datePicker_2" use:svlatepickr={defaultDateOptions} />
// [svp! ++]	</section>
// [svp! ++]	<br />
// [svp! ++]	<section>
// [svp! ++]		<label for="datePicker_3">Multiple date picker with flatpickr element binding: </label>
// [svp! ++]		<br />
// [svp! ++]		<input
// [svp! ++]			id="datePicker_3"
...
// [svp! ++]	<br />
// [svp! ++]	<section>
// [svp! ++]		<label for="datePicker_4">Multiple date picker with wrapper</label>
// [svp! ++]		<br />
...
<form name="datePickerForm" method="POST" use:enhance={beforeSubmitHandler} >
    <section>
        <label for="datePicker_1">Multiple date picker:
        <br />
        <input name="datePicker_1" use:svlatepickr={altInputOptions}>
    </section>
    <br />
    <section>
        <label for="datePicker_2">Multiple date picker with initial date: </label>
        <br />
        <input id="datePicker_2" name="datePicker_2" use:svlatepickr={defaultDateOptions} />
    </section>
    <br />
    <section>
        <label for="datePicker_3">Multiple date picker with flatpickr element binding: </label>
        <br />
        <input
            id="datePicker_3"
            name="datePicker_3"
    ...
    <br />
    <section>
        <label for="datePicker_4">Multiple date picker with wrapper</label>
        <br />
        <div use:svlatepickr={wrapOptions}>
