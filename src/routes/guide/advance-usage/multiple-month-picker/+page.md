---
title: Advance usage of Multiple month picker
---
...
Set a default date(s) to input after component is mounted
...
<script>
	...
	const options = {
		...
		altFormat: 'F Y',
		defaultDate: [
			/**Set default date as current month and both two months before*/ // [svp! ++]
			getFirstDaysOfMonth(0), // [svp! ++]
			getFirstDaysOfMonth(-1), // [svp! ++]
...
// [svp! ++]	<section>
// [svp! ++]		<label for="monthPicker_1">Multiple month picker:
// [svp! ++]		<br />
// [svp! ++]		<input name="monthPicker_1" use:svlatepickr={altInputOptions}>
// [svp! ++]	</section>
// [svp! ++]	<br />
// [svp! ++]	<section>
// [svp! ++]		<label for="monthPicker_2">Multiple month picker with initial date: </label>
// [svp! ++]		<br />
// [svp! ++]		<input id="monthPicker_2" name="monthPicker_2" use:svlatepickr={defaultDateOptions} />
// [svp! ++]	</section>
// [svp! ++]	<br />
// [svp! ++]	<section>
// [svp! ++]		<label for="monthPicker_3">Multiple month picker with flatpickr element binding: </label>
// [svp! ++]		<br />
// [svp! ++]		<input
...
// [svp! ++]	<br />
// [svp! ++]	<section>
// [svp! ++]		<label for="monthPicker_4">Multiple month picker with wrapper</label>
// [svp! ++]		<br />
...
<form name="datePickerForm" method="POST" use:enhance={beforeSubmitHandler} >
    <section>
        <label for="monthPicker_1">Multiple month picker:
        <br />
        <input name="monthPicker_1" use:svlatepickr={altInputOptions}>
    </section>
    <br />
    <section>
        <label for="monthPicker_2">Multiple month picker with initial date: </label>
        <br />
        <input id="monthPicker_2" name="monthPicker_2" use:svlatepickr={defaultDateOptions} />
    </section>
    <br />
    <section>
        <label for="monthPicker_3">Multiple month picker with flatpickr element binding: </label>
        <br />
        <input
            id="monthPicker_3"
            name="monthPicker_3"
    ...
    <br />
    <section>
        <label for="monthPicker_4">Multiple month picker with wrapper</label>
        <br />
        <div use:svlatepickr={wrapOptions}>
