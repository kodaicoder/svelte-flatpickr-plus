...
<h2 id="actions">Actions<a href="#actions" class="permalink">🔗</a></h2>
...
<br />
<h2 id="basic_usage">Basic Usage<a href="#basic_usage" class="permalink">🔗</a></h2>
...
<h2 id="options">Options <a href="#options" class="permalink">🔗</a></h2>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>null</td>
      <td>String</td>
      <td>This class will be added to the input element created by the altInput option.  Note that altInput already inherits classes from the original input.</td>
    </tr>
    <tr>
      <td>ariaDateFormat</td>
      <td>"F j, Y"</td>
      <td>String</td>
      <td>Defines how the date will be formatted in the aria-label for calendar days, using the same tokens as dateFormat. If you change this, you should choose a value that will make sense if a screen reader reads it out loud.</td>
    </tr>
    <tr>
      <td>autoFillDefaultTime</td>
      <td>true</td>
      <td>Boolean</td>
      <td>Whether the default time should be auto-filled when the input is empty and gains or loses focus.</td>
    </tr>
    <tr>
      <td>clickOpens</td>
      <td>true</td>
      <td>Boolean</td>
      <td>Whether clicking on the input should open the picker.
    Set it to false if you only want to open the calendar programmatically.</td>
    </tr>
    <tr>
      <td>closeOnSelect</td>
      <td>true</td>
    ...
    <tr>
      ...
      <td>", "</td>
      <td>String</td>
      <td> If "mode" is "multiple", this string will be used to join
    selected dates together for the date input value.</td>
    </tr>
    <tr>
      <td>dateFormat</td>
      <td>"Y-m-d"</td>
      <td>String</td>
      <td>A string of characters which are used to define how the date will be displayed in the input box. (<a href="https://flatpickr.js.org/formatting/" target="_blank">See supported format</a>)</td>
    </tr>
	<tr>
      <td>defaultDate</td>
      <td>null</td>
    ...
    <tr>
      ...
      <td>Disables certain dates, preventing them from being selected. (<a href="https://flatpickr.js.org/examples/#disabling-dates" target="_blank">See detail of enabling & disabling dates)</a></td>
    </tr>
    <tr>
      <td>disableMobile</td>
      <td>true</td>
      <td>Boolean</td>
      <td>Set this to true to always use the non-native picker on mobile devices. (By default is set to true to off a mobile mode for working with month plugin & year dropdown plugin)</td>
    </tr>
	<tr>
      <td>enable</td>
      <td>[]</td>
      <td>Date | string | number | function</td>
      <td>Disables all dates except these specified. (<a href="https://flatpickr.js.org/examples/#disabling-dates" target="_blank">See detail of enabling & disabling dates)</td>
    </tr>
    <tr>
      <td>enableSeconds</td>
      <td>false</td>
    ...
    <tr>
      ...
      <td>The locale, either as a string (e.g. "ru", "en") or as an object. (<a href="https://flatpickr.js.org/localization/" target="_blank">See Localization</a>)</td>
    </tr>
	<tr>
      <td>maxDate</td>
      <td>null</td>
...
Use it along with "enableTime" to create a time picker. </td>
    ...
    <tr>
      ...
      <td>false</td>
      <td>Boolean</td>
      <td>Enables the calendar to wrap around at the end of the month.</td>
    </tr>
    <tr>
      <td>useLocaleYear</td>
      <td>false</td>
