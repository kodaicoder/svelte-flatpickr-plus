 ...
 * @typedef {(dates: Date[], currentDateString: string, self: Instance, data?: any) => void} Hook
 */
 ...
 * @property {(date: Date, format: string, locale: Locale) => string} formatDate - Allows using a custom date formatting function instead of the built-in. Generally unnecessary.
 ...
 * @property {LocaleKey | Partial<CustomLocale>} locale - The locale, either as a string (e.g., "ru", "en") or as an object. See https://chmln.github.io/flatpickr/localization/
 ...
 * @property {"auto" | "above" | "below" | "auto left" | "auto center" | "auto right" | "above left" | "above center" | "above right" | "below left" | "below center" | "below right" | ((self: Instance, customElement: HTMLElement | undefined) => void)} position - How the calendar should be positioned with regards to the input. Defaults to "auto".
